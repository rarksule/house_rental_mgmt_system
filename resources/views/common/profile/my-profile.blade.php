                            ...
                            <div
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item">{{isAdmin() ? __('message.admin') : __('message.profile') }}</li>
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-md-4 mb-25">
                                                                ...
                                                                <input type="email" class="form-control" name="email"
                                                                    ...
                                                                    required
                                                                    value="{{ old('email', isset($user) ? $user->email : '') }}" {{isAdmin() ? '' : 'readonly'}}>
                                                                @error('email')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 mb-25">
                                                                <label class="label-text-title color-heading font-medium mb-2">{{ __('message.status') }}</label>
                                                                 <select id="status" name="status" class="form-control border-dark"> 
                                                                    ...
                                                                    <option value={{USER_STATUS_INACTIVE}}>{{__('message.inactive')}}</option>
                                                                </select>
                                                            </div>
